...
class PostController extends AbstractController
{
     ...
     *
     * @Route("/posts/{slug}/update", name="post_update", methods={"GET","POST"})
     * 
     * @param Post $post
     ...
     * @return void
     */
    public function update(Post $post, EntityManagerInterface $em, Request $request, PicturesHandler $picturesHandler, Slugify $slugify)
    {
    ...
    /**
     * @Route("/posts/{slug}/delete", name="post_desactivate")
     */
     ...
     */
    public function new(EntityManagerInterface $em, PicturesHandler $picturesHandler, Request $request, Slugify $slugify)
    {
        $post = new Post;
    ...
    /**
     * @Route("/posts/show/{slug}", name="post_show", methods={"GET"})
     */
